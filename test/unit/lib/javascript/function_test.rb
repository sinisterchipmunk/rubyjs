...
class Javascript::FunctionTest < ActiveSupport::TestCase
  ...
  test "produces a valid function with no arguments and no super" do
    function = Javascript::Function.new(:super => false)
  ...
  test "produces a valid function with a name and dynamic body" do
    function = Javascript::Function.new(:name, :name => :say_hello) do
      #alert("Hi, #{name}")
    end
